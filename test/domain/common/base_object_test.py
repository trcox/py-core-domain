...
class BaseObjectTest(unittest.TestCase):
  ...
  def test_compare_to(self):
    self.assertEqual( 1, self.bo1.compare_to(self.bo2), "Base object compare to method not working property")
    self.assertEqual(-1, self.bo2.compare_to(self.bo1), "Base object compare to method not working property")
    self.assertEqual(-1, self.bo1.compare_to(self.bo3), "Base object compare to method not working property")
